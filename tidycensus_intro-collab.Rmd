...
foreign_born_2009_2019 <- map_dfr(years, ~{
  get_acs(
    geography = "county",
    variables = c(percent_of_foreign_born_population_by_household = "DP02_0109P"),
    state = "HI",
...
ggplot(foreign_born_2009_2019, aes(x = year, y = estimate, group = 1)) + 
  geom_line() + 
  geom_point()
```
...
oahu_foreign_born_total_household_income <- get_acs(
  geography = "tract",
  variables = c(percent_of_foreign_born_population_by_household = "DP02_0109P",
                percent_of_total_household_income = "DP03_0051P"),
  state = "HI",
  county = "Honolulu",
  #geometry = TRUE,
  output = "wide",
...
ggplot(oahu_family_poverty_college_education, aes(x = percent_of_foreign_born_population_by_household, y = percent_of_total_household_incomeE)) +
  geom_point() +
  geom_smooth() +
  stat_cor() +
  theme_minimal()
